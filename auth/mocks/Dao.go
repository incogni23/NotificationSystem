...
// GetUserByID implements auth.Dao.
func (_m *Dao) GetUserByID(UserId uuid.UUID) (*auth.User, error) {
	panic("unimplemented")
}

// GetAllUsers implements auth.Dao.
func (_m *Dao) GetAllUsers() ([]auth.User, error) {
	panic("unimplemented")
}
